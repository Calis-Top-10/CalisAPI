...
variable "client_id" {
  type = string
  default = "327782085729-2ufk2e1fmmr67far9h9kdqlqnp7d0ssr.apps.googleusercontent.com,327782085729-h2n5snb0i2grgge995mkslhq3tgfd161.apps.googleusercontent.com,327782085729-964h8eq6s1ta2on9dag8r2g80l6kqoiq.apps.googleusercontent.com,327782085729-eqlor5jbl9cv3c06b77np9ic8so0sl01.apps.googleusercontent.com"
}
...
resource "google_cloudfunctions2_function" "getLesson" {
  name        = "getLesson"
  location    = "asia-southeast2"
  description = "for report learning"
  ...
  build_config {
    runtime     = "python310"
    entry_point = "lesson" # Set the entry point
    environment_variables = {
      GOOGLE_CLIENT_ID = var.client_id
    }
    source {
...
resource "google_cloudfunctions2_function" "getQuestion" {
  name        = "getQuestion"
  location    = "asia-southeast2"
  description = "for report learning"
  ...
  build_config {
    runtime     = "python310"
    entry_point = "question" # Set the entry point
    environment_variables = {
      GOOGLE_CLIENT_ID = var.client_id
    }
    source {
